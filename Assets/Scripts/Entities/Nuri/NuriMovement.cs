...
public class NuriMovement : MonoBehaviour {
    ...
    void Update() {
        ...
        float targetCatchUpSpeed = Mathf.Lerp(minCatchUpSpeed, maxCatchUpSpeed, Mathf.Clamp01(distance / catchUpDistanceThreshold));
        
        _smoothedCenter = Vector3.MoveTowards(_smoothedCenter, player.transform.position, targetCatchUpSpeed * Time.deltaTime);
